...
|`ZIPKIN_HOST`
|Specify host of the `Zipkin` to use (default `localhost`)

|`ZIPKIN_PORT`
|Specify port of the `Zipkin` to use (default `9411`)
...
|`ZIPKIN_HOST`
|Specify host of the `Zipkin` to use (default `localhost`). Default port is `9411`.
