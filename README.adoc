...
image:https://img.shields.io/badge/License-MIT-green.svg[License: MIT, link=LICENSE]
image:https://img.shields.io/badge/Buy%20Me%20A%20Coffee-ivan.franchin-FFDD00?logo=buymeacoffee&logoColor=black[Buy Me A Coffee, link=https://buymeacoffee.com/ivan.franchin]
...
Uses https://github.com/diffplug/spotless/tree/main/plugin-maven[Spotless Maven Plugin] + https://github.com/google/google-java-format[Google Java Format] (Java) and https://prettier.io/[Prettier] (JS/HTML) for automated formatting.
...
* [Medium]: https://medium.com/itnext/how-i-reduce-gif-and-screenshot-sizes-for-my-technical-articles-on-macos-7fea331afc68[**How I Reduce GIF and Screenshot Sizes for My Technical Articles on macOS**]

== Support

If you find this useful, consider buying me a coffee:

image:https://cdn.buymeacoffee.com/buttons/v2/default-yellow.png[Buy Me A Coffee, link=https://buymeacoffee.com/ivan.franchin, height=50]
